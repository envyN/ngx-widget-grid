...
export class GridRenderer {
  ...
  setWidgetPosition(widgetId: string, newPosition: Rectangle) {
  ...
  setObstructionValues(area: Rectangle, value: number) {
  ...
  render(grid: Grid, emitWidgetPositionUpdated?: Function) {
    ...
    unpositionedWidgets.forEach((widget: WidgetConfig) => {
      ...
      if (nextPosition !== null) {
        ...
        this.setWidgetPosition(widget.getId(), new Rectangle());
      }
