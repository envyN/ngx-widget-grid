...
@Component({
             ...
             templateUrl: './fixed-dimension-example.component.html',
             styleUrls: ['./fixed-dimension-example.component.scss']
           })
export class FixedDimensionExampleComponent implements OnInit {
